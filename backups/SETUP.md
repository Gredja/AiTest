...
## Часть 6. Как работать с MiMoCode
...
| `/commit` | Форматирование + ревью + тесты + коммит + пуш |
...
## Часть 7. Структура проекта Gredja
...
## Часть 8. Краткий справочник правил
...
Напиши `/commit` — MiMoCode проверит форматирование, сделает ревью, запустит HealthCheck-тесты, закоммитит и запушит.
...
## Часть 10. Контакты и полезные ссылки
