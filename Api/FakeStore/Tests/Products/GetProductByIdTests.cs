...
public class GetProductByIdTests : RequestHelper
{
    ...
    {
        var response = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(TestProductId));
    ...
    {
        var allProducts = await Get<List<ProductModelResponse>>(FakeStoreEndpoints.Products, Method.Get);
        var maxId = allProducts.Data!.Max(p => p.Id);
        var nonExistentId = maxId + 1;

        var response = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(nonExistentId));
    ...
    {
        var response = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(0));
    ...
    {
        var response = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(-1));
    ...
    {
        var response = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(BoundaryProductId));
    ...
    {
        var response = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(LastProductId));
    ...
    {
        var response1 = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(TestProductId));
        var response2 = await Get<ProductModelResponse>(FakeStoreEndpoints.ProductsById, Method.Get, IdParam(TestProductId));
